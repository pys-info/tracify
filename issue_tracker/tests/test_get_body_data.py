...
class GetBodyDataTestCase(TestCase):
    ...
    def test_form_urlencoded_content_type(self):
        ...
        request = request.post('', data=b'name=John&age=30', content_type='application/x-www-form-urlencoded')
    ...
    def test_multipart_form_data_content_type(self):
        ...
        expected_result = {'name': 'John', 'age': '30', 'file': ['sample.jpg'],
                           'file1': ['sample.jpg']}
    ...
    def test_multipart_form_data_content_type_else_part(self):
        ...
        request = request_factory.put('', data=multipart_data.to_string(), content_type='multipart/form-data')
    ...
    def test_application_json_content_type(self):
        request = RequestFactory()
        request = request.post('', data=b'{"name": "John", "age": 30}', content_type='application/json')
