...
class TestIssueTrackerChannelsConfiguration:
    def test_missing_configuration(self, issue_tracker_channels_configuration):
        ...
        with pytest.raises(ImproperlyConfigured):
            raise ImproperlyConfigured("ISSUE_TRACKER_CHANNELS_CONFIGURATION is missing")
    ...
    def test_valid_configuration(self, issue_tracker_channels_configuration):
        ...
        """
        app_settings.ISSUE_TRACKER_CHANNELS_CONFIGURATION = issue_tracker_channels_configuration
        assert app_settings.ISSUE_TRACKER_CHANNELS_CONFIGURATION["CHANNEL_ONE"]["credentials"][
                   "WEBHOOK_URL"] == "fake channel one webhook url"
        assert app_settings.ISSUE_TRACKER_CHANNELS_CONFIGURATION["CHANNEL_TWO"]["credentials"][
    ...
    def test_invalid_configuration(self):
       ...
       """
        ...
        with pytest.raises(ImproperlyConfigured):
            raise ImproperlyConfigured("ISSUE_TRACKER_CHANNELS_CONFIGURATION is invalid")
